...
const originalStart = barcodeService.start;

barcodeService.maxTimeBetweenKeysInMs = session.max_time_between_keys_in_ms || 150,
barcodeService.isMobileChrome = isMobileOS() && isBrowserChrome(),
barcodeService.cleanBarcode = function(barcode) {
    return barcode.replace(/Alt|Shift|Control/g, '');
}

barcodeService.start = function() {
